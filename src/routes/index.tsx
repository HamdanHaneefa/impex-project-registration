      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 sm:pt-32 sm:pb-24 grid lg:grid-cols-2 gap-6 lg:gap-14 items-center min-h-screen">
        <div className="space-y-5 sm:space-y-6">
          <motion.p
            ...
            className="text-sm sm:text-base lg:text-lg leading-relaxed drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]"
            style={{ textShadow: '0 2px 12px rgba(0,0,0,0.8)' }}
          >
            <span className="font-bold text-white text-lg sm:text-xl lg:text-2xl">Struggling to keep your institution ahead in AI-driven education?</span>
            <br />
            <span className="text-white/90 font-medium">Discover how IFPD Meet 2026 transforms classrooms with cutting-edge interactive technology.</span>
          </motion.p>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <Reveal>
            <div>
              ...
              <div className="mt-6 inline-flex items-center gap-2 rounded-full bg-red-500/10 border border-red-500/20 text-red-600 px-4 py-2 text-sm font-bold">
          ...
          <Reveal delay={0.1}>
            <div className="rounded-2xl overflow-hidden border border-border shadow-elegant">
              <img
                src="/xseries-display-1.png"
                alt="IFPD Interactive Flat Panel Display"
        ...
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl bg-gradient-primary p-8 sm:p-12 text-center shadow-brand">
            ...
            <div className="relative">
              <div className="inline-flex items-center gap-2 rounded-full bg-red-500 backdrop-blur border border-white/30 px-4 py-2 animate-pulse">
              ...
              <p className="mt-3 text-primary-foreground/85 max-w-2xl mx-auto">
                ...
                <span className="text-lg font-semibold text-red-100">38 people have already registered. Seats filling fast!</span>
              </p>
              <div className="mt-4 max-w-md mx-auto bg-white/10 rounded-full h-3 overflow-hidden">
                <div className="bg-white h-full rounded-full" style={{ width: '76%' }}></div>
              </div>
              <p className="mt-2 text-sm text-primary-foreground/70">76% of seats already taken</p>
              <a
                href="#register-bottom"
                className="mt-6 inline-flex items-center gap-2 rounded-full bg-white text-primary px-6 py-3.5 text-sm font-semibold hover:bg-white/90 shadow-xl hover:scale-105 transition-all"
              >
                <span className="line-through opacity-60">₹9,999</span>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/85">
            <li className="flex items-center gap-2">
              ...
              <a href="tel:+919778665499" className="hover:underline">+91 97786 65499</a>
            </li>
            <li className="flex items-center gap-2">
            ...
            <li className="flex items-center gap-2">
              ...
              <a href="https://wa.me/919778665499" target="_blank" rel="noopener noreferrer" className="hover:underline">WhatsApp Us</a>
            </li>
          </ul>
        </div>
      </div>
